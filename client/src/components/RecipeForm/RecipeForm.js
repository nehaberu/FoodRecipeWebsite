        ...
        return (
            <div id = 'recipes-right'>
                <div id = 'recipes-form-holder'>
                    <form >
                        <input id = 'form-title' type = 'text' placeholder = 'The dish' name = 'title' autoComplete = 'off' />
                        <input id = 'form-image' type = 'file' placeholder = 'Upload an image' name = 'image' />
                        <input id = 'form-duration' type = 'text' placeholder = 'Prep time' name = 'duration' autoComplete = 'off'/>
                        <textarea id = 'form-steps' placeholder = 'Procedure' name = 'steps'></textarea>
